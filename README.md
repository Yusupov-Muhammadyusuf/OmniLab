...
## What we learned
Building this project taught me a lot about strict state lifecycle management in modern JavaScript and the importance of precise data-contract enforcement when integrating AI outputs into runtime UI elements. I also sharpened my skills in UI/UX architecture, discovering how to distill high-density academic and chemical data into a clean, minimalist dashboard that doesn't overwhelm the user.
